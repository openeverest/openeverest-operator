...
export PXC_OPERATOR_VERSION=${PXC_OPERATOR_VERSION:-"1.19.0"}
echo "PXC_OPERATOR_VERSION=${PXC_OPERATOR_VERSION}"

export PXC_DB_ENGINE_VERSION=${PXC_DB_ENGINE_VERSION:-"8.0.44-35.1"}
echo "PXC_DB_ENGINE_VERSION=${PXC_DB_ENGINE_VERSION}"

# Recommended DB engine version available in PREVIOUS_PXC_OPERATOR_VERSION
export PREVIOUS_PXC_DB_ENGINE_VERSION=${PREVIOUS_PXC_DB_ENGINE_VERSION:-"8.0.42-33.1"}
echo "PREVIOUS_PXC_DB_ENGINE_VERSION=${PREVIOUS_PXC_DB_ENGINE_VERSION}"

export PSMDB_OPERATOR_VERSION=${PSMDB_OPERATOR_VERSION:-"1.21.2"}
echo "PSMDB_OPERATOR_VERSION=${PSMDB_OPERATOR_VERSION}"

export PSMDB_DB_ENGINE_VERSION=${PSMDB_DB_ENGINE_VERSION:-"8.0.17-6"}
...
export PREVIOUS_PSMDB_DB_ENGINE_VERSION=${PREVIOUS_PSMDB_DB_ENGINE_VERSION:-"8.0.12-4"}
echo "PREVIOUS_PSMDB_DB_ENGINE_VERSION=${PREVIOUS_PSMDB_DB_ENGINE_VERSION}"

export PG_OPERATOR_VERSION=${PG_OPERATOR_VERSION:-"2.9.0"}
echo "PG_OPERATOR_VERSION=${PG_OPERATOR_VERSION}"

export PG_DB_ENGINE_VERSION=${PG_DB_ENGINE_VERSION:-"18.3"}
echo "PG_DB_ENGINE_VERSION=${PG_DB_ENGINE_VERSION}"

# Recommended DB engine version available in PG_OPERATOR_VERSION for upgrading from PREVIOUS_PG_OPERATOR_VERSION
export PG_DB_UPGRADE_ENGINE_VERSION=${PG_DB_UPGRADE_ENGINE_VERSION:-"17.9"}
echo "PG_DB_UPGRADE_ENGINE_VERSION=${PG_DB_UPGRADE_ENGINE_VERSION}"

# Recommended DB engine version available in PREVIOUS_PG_OPERATOR_VERSION
export PREVIOUS_PG_DB_ENGINE_VERSION=${PREVIOUS_PG_DB_ENGINE_VERSION:-"17.7"}
...
export PREVIOUS_PG_OPERATOR_VERSION=${PREVIOUS_PG_OPERATOR_VERSION:-"2.8.2"}
echo "PREVIOUS_PG_OPERATOR_VERSION=${PREVIOUS_PG_OPERATOR_VERSION}"

export PREVIOUS_PXC_OPERATOR_VERSION=${PREVIOUS_PXC_OPERATOR_VERSION:-"1.18.0"}
echo "PREVIOUS_PXC_OPERATOR_VERSION=${PREVIOUS_PXC_OPERATOR_VERSION}"

export PREVIOUS_PSMDB_OPERATOR_VERSION=${PREVIOUS_PSMDB_OPERATOR_VERSION:-"1.21.1"}
