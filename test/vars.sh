...
export PXC_DB_ENGINE_VERSION=${PXC_DB_ENGINE_VERSION:-"8.4.8-8.1"}
echo "PXC_DB_ENGINE_VERSION=${PXC_DB_ENGINE_VERSION}"

# Recommended DB engine version available in PREVIOUS_PXC_OPERATOR_VERSION
export PREVIOUS_PXC_DB_ENGINE_VERSION=${PREVIOUS_PXC_DB_ENGINE_VERSION:-"8.4.7-7.1"}
...
export PREVIOUS_PXC_OPERATOR_VERSION=${PREVIOUS_PXC_OPERATOR_VERSION:-"1.19.0"}
