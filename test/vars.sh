...
export PG_DB_ENGINE_VERSION=${PG_DB_ENGINE_VERSION:-"18.4"}
...
export PG_DB_UPGRADE_ENGINE_VERSION=${PG_DB_UPGRADE_ENGINE_VERSION:-"18.4"}
...
export PREVIOUS_PG_DB_ENGINE_VERSION=${PREVIOUS_PG_DB_ENGINE_VERSION:-"18.3"}
