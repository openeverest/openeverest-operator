...
export PG_OPERATOR_VERSION=${PG_OPERATOR_VERSION:-"2.8.1"}
...
export PREVIOUS_PG_DB_ENGINE_VERSION=${PREVIOUS_PG_DB_ENGINE_VERSION:-"17.6"}
...
export PREVIOUS_PG_OPERATOR_VERSION=${PREVIOUS_PG_OPERATOR_VERSION:-"2.8.0"}
