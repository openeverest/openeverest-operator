...
require (
	...
	github.com/percona/percona-postgresql-operator/v3 v3.1.0
	github.com/percona/percona-server-mongodb-operator v1.22.0
	github.com/percona/percona-xtradb-cluster-operator v1.20.0
...
// cert-manager v1.21 removed the meta/v1 ObjectReference alias, which the PSMDB
// and PXC operator API types still reference.
